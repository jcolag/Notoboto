...
# A list of English-language "stop words" that don't add any useful
# information to, for example, a title.
...
set stopwords {
  ...
  herse him himse his how however hundred i ie if in inc indeed interest
  into is it its itse keep last latter latterly least less ltd made many
  may me meanwhile might mill mine more moreover most mostly move much
  must my myse name namely neither never nevertheless next nine no nobody
  ...
  come day good just know like look make new people say think time use
  want way work year
}
